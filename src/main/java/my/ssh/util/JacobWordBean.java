...
public class JacobWordBean {
    ...
    public JacobWordBean(boolean visible) throws Exception {
        if (word == null) {
...
//		doc = Dispatch.call(documents, "Open", docPath).toDispatch();
     ...
     * 在当前插入点插入文件
     *
     * @param filePath 要插入的文件路径
     */
    public void insertFile(String filePath) {
        Dispatch.invoke(selection, "InsertFile", Dispatch.Method, new Object[] { filePath, "", new Variant(false), new Variant(false), new Variant(false) }, new int[3]);
    }
