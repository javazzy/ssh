...
CREATE TABLE `sys_user` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='系统 - 用户表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_user` VALUES (1,'admin','21232f297a57a5a743894a0e4a801fc3',1,1,1,1),(2,'anonymous',NULL,1,1,1,1),(3,'test','test',1,1,1,1);
...
-- Dump completed on 2016-04-12 23:37:21
